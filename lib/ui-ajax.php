...
function contact($data){
 ...
 $html .= '<a href="'.get_bloginfo('url').'" title="'.get_bloginfo('title').'"><img style="margin:0 auto;" width="200" height="auto" src="' . $_POST['siteurl'] . 'ui-loraine/img/LORAINEDIEGOMD.png" alt="'.get_bloginfo('name').'" title="'.get_bloginfo('name').'" /></a>';
	$html .= '</div>';
...
function schedule($data){
	...
	$html = '<div style="width: 600px; margin: 0 auto;">';
  		$html .= '<div style="text-align: center; padding: 15px; margin-bottom: 1em; background: #5091CD;">';
			$html .= '<a href="'.get_bloginfo('url').'" title="'.get_bloginfo('title').'"><img style="margin:0 auto;" src="' . $_POST['siteurl'] . '/wp-content/themes/ui-loraine/img/LORAINEDIEGOMD.png" width="200" height="auto" alt="'.get_bloginfo('name').'" title="'.get_bloginfo('name').'" /></a>';
		$html .= '</div>';
		$html .= '<table style="border: 1px solid #2b2b2b; border-collapse: collapse; width: 100%;">';
